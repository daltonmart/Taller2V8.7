...
public class JuegoHistoria extends javax.swing.JFrame {
    ...
    private void iniciarCampania() {
        jTxtACHistoria.setLineWrap(true);
        jTxtACHistoria.setText(iPrincipal.obtenerHistoriaUsuarioSesion());
        jlContenidoPista.setHorizontalAlignment(SwingConstants.CENTER);
        jlContenidoPista.setVerticalAlignment(SwingConstants.CENTER);
        jlContenidoPista.setVerticalTextPosition(SwingConstants.CENTER);
        jlContenidoPista.setHorizontalTextPosition(SwingConstants.CENTER);
        jlContenidoPista.setText(historia.obtenerPistaDeCampania(iSesion.getNroCampania(), iSesion.getProgreso()));
        System.out.println(iSesion.getNroCampania());
        System.out.println(iSesion.getProgreso());
    }
    ...
    private void initComponents() {
        ...
        jTxtCPista = new javax.swing.JTextArea();
        jlTituloHistoria = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTxtACHistoria = new javax.swing.JTextArea();
        ...
        getContentPane().add(jpanelEncabezado, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 60));
        ...
        jPanel2.add(jSiguienteMision, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, -1, -1));
        ...
        jlContenidoPista.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        ...
        jTxtCPista.setBackground(new java.awt.Color(0, 0, 0));
        jTxtCPista.setColumns(20);
        jTxtCPista.setFont(new java.awt.Font("OCR A Extended", 0, 14)); // NOI18N
        jTxtCPista.setForeground(new java.awt.Color(0, 204, 102));
        jTxtCPista.setLineWrap(true);
        jTxtCPista.setRows(5);
        jScrollPane2.setViewportView(jTxtCPista);

        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-290, 300, 290, 140));
        ...
        jTxtACHistoria.setBackground(new java.awt.Color(0, 0, 0));
        jTxtACHistoria.setColumns(20);
        jTxtACHistoria.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jTxtACHistoria.setForeground(new java.awt.Color(0, 153, 102));
        jTxtACHistoria.setRows(5);
        jScrollPane1.setViewportView(jTxtACHistoria);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 470, 200));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/imagenes/Terminal.gif"))); // NOI18N
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, -1, -1));

        jtxtTerminal.setBackground(new java.awt.Color(0, 0, 0));
        jtxtTerminal.setColumns(20);
        jtxtTerminal.setFont(new java.awt.Font("Courier", 0, 12)); // NOI18N
        ...
        jPanel2.add(jScrollPaneTerminal, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 60, 620, 430));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 1130, 510));
    ...
    private void jtxtTerminalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtTerminalKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (!lineaTextoIngresada.equals("clear")) {
    ...
    private void jSiguienteMisionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSiguienteMisionActionPerformed
        ...
        jTxtACHistoria.setLineWrap(true);
        jTxtACHistoria.setText(iPrincipal.obtenerHistoriaUsuarioSesion());
        jlContenidoPista.setAutoscrolls(true);
        jlContenidoPista.setText(historia.obtenerPistaDeCampania(iSesion.getNroCampania(), iSesion.getProgreso()));
    ...
    private javax.swing.JTextArea jTxtACHistoria;
    private javax.swing.JTextArea jTxtCPista;
